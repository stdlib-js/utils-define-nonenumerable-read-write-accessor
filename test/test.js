...
var setNonEnumerableReadWriteAccessor = require( './../lib' ); // eslint-disable-line id-length
...
tape( 'the function sets a property on a provided object', function test( t ) {
	...
	t.strictEqual( obj.foo, val, 'returns expected value' );
...
tape( 'the read-write property is writable', function test( t ) {
	...
	setNonEnumerableReadWriteAccessor( obj, 'foo', getter, setter );
	t.strictEqual( obj.foo, 0, 'returns expected value' );

	obj.foo = 1;
	t.strictEqual( obj.foo, 1, 'returns expected value' );
...
tape( 'the read-write property is not enumerable', function test( t ) {
	var obj = {};
	var val = 0;

	setNonEnumerableReadWriteAccessor( obj, 'foo', getter, setter );

	t.strictEqual( objectKeys( obj ).length, 0, 'property is not enumerable' );
	t.end();
